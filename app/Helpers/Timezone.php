...
class Timezone
{
    ...
    public static $time_format = [
        'Y-m-d H:i:s T'     => '2018-03-10 17:16:18 NZST',
        'F j, Y, g:i a'     => 'March 10, 2018, 5:16 pm ',
        'D M j G:i:s T Y'   => 'Sat Mar 10 17:16:18 NZST 2018',
        'g:i a, F j'        => '5:16 pm, March 10',
        'g:i a, d/m/y'      => '5:16 pm, 10/03/16',
        'g:i a, m/d/y'      => '5:16 pm, 03/10/16',
        'F jS - h:i:s A T'  => 'March 10th - 05:16:18 PM NZST'
    ];

    public static function getDate($time, $format = 'F j, Y, g:i a', $custom_format = false, $tzId = 'UTC')
    {
        if (is_null($time)) {
            return null;
        }
