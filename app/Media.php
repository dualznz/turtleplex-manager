...
class Media extends Model
{
     ...
     */
    protected $fillable = [
        'id', 'server_id', 'drive_id', 'drive_asset_id', 'state_asset_id', 'hash_id', 'tmdb_id', 'media_title', 'slug', 'release_year', 'vote_average', 'poster_92_path', 'poster_154_path', 'backdrop_path', 'media_type', 'overview'
    ];
