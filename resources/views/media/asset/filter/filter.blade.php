...
@section('rightbar-content')
    ...
    <div class="xp-breadcrumbbar text-center">
        <h4 class="page-title">Media List: {{ $asset->asset_name }} / {{ $stateAsset->asset_name }}</h4>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('media-asset', [$server->slug, $drive->slug, $asset->id]) }}">Media List: {{ $asset->asset_name }}</a></li>
            <li class="breadcrumb-item active">{{ $stateAsset->asset_name }}</li>
        </ol>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    <div class="card-header bg-white">
                        <h5 class="card-title text-black">Media List Filter &nbsp;&nbsp;&nbsp;{!! \App\Helpers\AccentHelper::accent($stateAsset->asset_name, $stateAsset->text_color, $stateAsset->background_color) !!} &nbsp;&nbsp;&nbsp;<small class="text-green"><i class="fa fa-folder-open"></i> {{ $drive->server->network_path.$drive->drive_folder.$asset->asset_folder }}</small></h5>
                        <h6 class="card-subtitle">View filtered media contained within selected asset folder.</h6>
                    </div>
                    <div class="card-body">
