...
@section('rightbar-content')
    ...
    <div class="xp-breadcrumbbar text-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><i class="far fa-pencil"></i> Edit Role: {{ $r->name }}</li>
        </ol>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    <div class="card-header bg-white">
                        ...
                        <h6 class="card-subtitle">Update existing user groups in which you can assign members to in their profiles and the permissions below will be automatically assigned to them.</h6>
                    </div>
                    <div class="card-body">
